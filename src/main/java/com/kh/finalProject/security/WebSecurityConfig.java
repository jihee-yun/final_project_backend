...
public class WebSecurityConfig {
        ...
        public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
            http
                    ...
                    .authorizeRequests()
                    // 경로에 대해 인증 없이 접근을 허용
                    .antMatchers("/auth/**", "/mypage/**", "/cafe/region", "/cafe/detail", "/cafe/img", "/event/**", "/koauth/**", "/couponstore/**", "/guild/all", "/guild/detail", "/guild/isMember", "/user/**", "/roulette/**", "/quizmain/**", "/member/**", "/token/**", "/review/**", "/couponpayment/**", "/admin/**", "/report/**", "/mychallenge/**", "/main/**").permitAll() // 어떤 패스로 들어올 때 접근을 허용해줄건지
